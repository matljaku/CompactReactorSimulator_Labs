filename_1 = "EX_output_wSCRAM.dat"
filename_2 = "EX_output_woSCRAM.dat"
filename_3 = "EX_output_01SCRAM.dat"
filename_4 = "EX_output_05SCRAM.dat"
parameters = [], pom = 0
...
File.open("final_gnuplot.gnu", "w") do |w|
    parameters.each do |par|
        ...
        File.foreach("template_gnuplot.gnu") do |line|
            ...
            mod_line = mod_line.gsub("<<filename3>>", filename_3) 
            mod_line = mod_line.gsub("<<filename4>>", filename_4)
            w.puts mod_line
